...
const greeting = {
  ...
  subTitle:
    "A passionate individual who always thrives to work on end to end products. Software Engineer Intern at FICO || 4🌟 codechef competitive coder || Freelancer",
  resumeLink:
...
const skills = {
  data: [
    ...
    // },
    {
      ...
      skills: [
        "⚡ Building responsive front end using REACT, ANGULAR.",
        "⚡ Creating Application Backend using NodesJS ExpressJS MondoDB SQL.",
    ...
    },
    {
      ...
      fileName: "MobAppImg",
      skills: [
        "⚡ Building responsive Mobile Application using Android Studio or Flutter.",
        "⚡ Integrating Android Application with RestFul Api",
        "⚡ Deploying Application on Google Play store",
      ],
      softwareSkills: [
        {
  ...
  degrees: [
    {
      ...
      descriptions: [
        ...
        "⚡ Apart from this, I have done courses on Deep Learning, Data Science, Android App Development ,Full Stack Development, Angular, React, Blockchain, AR/VR.",
